package com.zhaoxuan.wehome.view.widget.softwidget;
...
import com.zhaoxuan.wehome.view.widget.softwidget.PaintBox.DrawingCanvas;
import com.zhaoxuan.wehome.view.widget.softwidget.PaintBox.PaintBox;
...
public class SRoundRect_Button extends Button {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(localDrawingCanvas==null){
            ...
            PaintBox.drawRoundRect(localDrawingCanvas, backgroundColor, 100);
