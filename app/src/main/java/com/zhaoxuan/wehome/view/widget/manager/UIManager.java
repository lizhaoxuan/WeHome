package com.zhaoxuan.wehome.view.widget.manager;
...
public class UIManager {
    ...
    * */
    ...
    private UIManager(Context context, View userView, Toolbar toolbar, View topWidget,
    ...
    public static class Builder{
        ...
        public UIManager build(){
            return new UIManager(context,userView,toolbar,topWidget,
